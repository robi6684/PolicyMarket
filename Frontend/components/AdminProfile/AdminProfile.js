...
const AdminProfile = () => {
    ...
    const getAdmin = async () =>{
      try {
        response = await axios.get(`http://localhost:8086/adminapp/getAdmin/${username}`,{
          headers :{
    ...
    const handleUpdate = async () =>{
      ...
      if(!isValidlastName){
        ...
        await axios.put(`http://localhost:8086/adminapp/updateAdmin/${adminid}`,{
            firstname,
            lastname,
        },{
            headers :{
    ...
    const update = async () =>{
      ...
      if(password !== newpassword){
        ...
        await axios.put(`http://localhost:8086/adminapp/updatePassword/${adminid}/${password}`,{
