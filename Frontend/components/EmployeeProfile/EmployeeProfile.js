...
const EmployeeProfile = () => {
    ...
    const getEmployee = async () =>{
      try {
        response = await axios.get(`http://localhost:8086/employeeapp/getEmployee/${username}`,{
            headers :{
    ...
    const handleUpdate = async () =>{
      ...
      if(!isValidlastName){
        ...
        await axios.put(`http://localhost:8086/employeeapp/updateEmployee/${employeeid}`,{
            firstname,
            lastname,
        },{
            headers :{
    ...
    const update = async () =>{
      ...
      if(password !== newpassword){
        ...
        await axios.put(`http://localhost:8086/employeeapp/updatePassword/${employeeid}/${password}`,{
